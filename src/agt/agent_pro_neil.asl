										    ...
										    if(opponentMark(1,1) & oppCorner(2,0)){
                                                ...
                                                if(opponentMark(1,1) & oppCorner(0,0)){
                                                    ...
                                                    if(opponentMark(1,1) & oppCorner(2,2)){
                                                        ...
                                                        if(opponentMark(0,1) & oppCorner(0,2)){
                                                            play(0,0)
                                                        } else{
                                                            if(oppCorner(0,0) & opponentMark(0,1)){
                                                                play(0,2)
                                                            } else{
                                                                if (opponentMark(1,1) & oppCorner(1,2)){
                                                                    play(1,0)
                                                                } else{
                                                                    if (opponentMark(1,0) & opponentMark(1,1)){
                                                                        play(1,2)
                                                                    } else{
                                                                        if (opponentMark(2,1) & oppCorner(2,2)){
                                                                            play(2,0)
                                                                        } else{
                                                                            if (oppCorner(2,0) & opponentMark(2,1)){
                                                                                play(2,2)
                                                                            } else{
                                                                                if (oppCorner(0,0) & opponentMark(1,0)){
                                                                                    play(2,0)
                                                                                } else{
                                                                                    if (oppCorner(2,0) & opponentMark(1,0)){
                                                                                        play(0,0)
                                                                                    } else{
                                                                                        if (opponentMark(0,1) & opponentMark(1,1)){
                                                                                            play(2,1)
                                                                                        } else{
                                                                                            if (opponentMark(2,1) & opponentMark(1,1)){
                                                                                                play(0,1)
                                                                                            } else{
                                                                                                if(oppCorner(0,2) & opponentMark(1,2)){
                                                                                                    play(2,2)
                                                                                                } else{
                                                                                                    if (oppCorner(2,2) & opponentMark(1,2)){
                                                                                                        play(0,2)
                                                                                                    } else{
